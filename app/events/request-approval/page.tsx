...
import { RequestApprovalForm } from "@/components/events/request-approval-form";

export default async function RequestEventApprovalPage() {
  let club;
  try {
  ...
  return (
    <div className="min-h-screen bg-page p-6">
      <div className="mx-auto max-w-xl">
        ...
        <RequestApprovalForm fields={fields} />
      </div>
    </div>
  );
}
