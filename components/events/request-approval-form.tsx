...
export function RequestApprovalForm({ fields }: RequestApprovalFormProps) {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    setSubmitting(true)
    try {
      const response = await fetch("/api/events/request-approval", {
        method: "POST",
      ...
      router.push("/events/request-approval/confirmation")
    } catch {
