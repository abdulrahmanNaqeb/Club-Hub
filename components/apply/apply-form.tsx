...
export function ApplyForm({ institutionSlug, fields }: ApplyFormProps) {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    try {
      const response = await fetch(
        `/api/institutions/${institutionSlug}/applications`,
        {
          method: "POST",
      ...
      router.push(`/apply/${institutionSlug}/confirmation`)
    } catch {
